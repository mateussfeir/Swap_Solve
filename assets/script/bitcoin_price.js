document.addEventListener("DOMContentLoaded", function() {
  ...
  // Function to fetch and update Bitcoin data
  ...
  // Call updateBitcoinData initially and then every 15 seconds
  updateBitcoinData(); // Call initially
  setInterval(updateBitcoinData, 15000); // Call every 15 secondS (15000 milliseconds)
});
